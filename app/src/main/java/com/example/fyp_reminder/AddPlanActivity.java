...
public class AddPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.add_plan_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Add New Plan");
    ...
    private void SaveChange()
    {
        ...
        {
            String ReminderRef = "PlanEvents/" + currentUserID;

            DatabaseReference PlanEventKeyRef = myRef.child("PlanEvents").child(currentUserID).push();
            ...
            myRef.updateChildren(EventContent).addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task)
                {
                    ...
                    {
                        Toast.makeText(AddPlanActivity.this, "Save Successful", Toast.LENGTH_SHORT).show();
                        GoToMainActivity();
                    }
                    else
                    {
                        Toast.makeText(AddPlanActivity.this, "Save Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    {
        Intent mainIntent = new Intent(AddPlanActivity.this,MainActivity.class);
